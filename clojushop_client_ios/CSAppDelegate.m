...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController {
    ...
    int savedTab = [(NSNumber*)[def objectForKey:@"activeTab"] intValue];
    
    if (savedTab != tabIndex) {
        [def setInteger: savedTab forKey:@"prevActiveTab"];
        [def setInteger: tabIndex forKey:@"activeTab"];
        [def synchronize];
    }
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"clojushop_client" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"clojushop_client.sqlite"];
